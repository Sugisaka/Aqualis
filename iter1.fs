...
namespace Aqualis
    ...
    type iter () =
        ...
        ///<summary>指定した範囲でループ</summary>
        static member range_reverse (i1:int0) = fun (i2:int0) -> fun code -> 
            match p.lang with
            |F ->
                let p = p.param
                p.getloopvar <| fun counter ->
        ...
        ///<summary>指定した範囲でループ</summary>
        static member range_reverse_exit (i1:int0) = fun (i2:int0) -> fun code -> 
            match p.lang with
            |F ->
                let p = p.param
                p.getloopvar_exit <| fun (goto,counter,exit) ->
        ...
        ///<summary>指定した範囲でループ</summary>
        static member range_interval (i1:int0) = fun (i2:int0) -> fun (ii:int0) -> fun code -> 
            match p.lang with
            |F ->
                let p = p.param
                p.getloopvar <| fun counter ->
        ...
        ///<summary>指定した範囲でループ(途中脱出可)</summary>
        static member range_interval_exit (i1:int0) = fun (i2:int0) -> fun (ii:int0) -> fun code -> 
            match p.lang with
            |F ->
                let p = p.param
                p.getloopvar_exit <| fun (goto,counter,exit) ->
        ...
        ///<summary>指定した範囲でループ</summary>
        static member range_interval (i1:int) = fun (i2:int) -> fun (ii:int0) -> fun code -> 
