...
Compile [Fortran;C99;Python] outputdir (projectname+"tw") version <| fun ctx ->
...
Compile [Fortran;C99;Python] outputdir (projectname+"tr") version <| fun ctx ->
    ctx.ch.iidz <| fun (n,m,x,z) ->
        n <== 1
        m <== 2
        x <== 1.234
...
Compile [Fortran;C99;Python] outputdir (projectname+"bw") version <| fun ctx ->
    ctx.ch.iidz <| fun (n,m,x,z) ->
        n <== 1
        m <== 2
        x <== 1.234
...
Compile [Fortran;C99;Python] outputdir (projectname+"br") version <| fun ctx ->
    ctx.ch.iidz <| fun (n,m,x,z) ->
        n <== 1
        m <== 2
        x <== 1.234
