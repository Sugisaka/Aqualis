namespace Aqualis
    ...
    type ch =
        ...
        static member i code = 
            let c,r = programList[prIndex].i0.getVar()
            code <| num0(Var(It 4, c, NaN))
            r()
        static member d code = 
            let c,r = programList[prIndex].d0.getVar()
            code <| num0(Var(Dt, c, NaN))
            r()
        static member z code = 
            let c,r = programList[prIndex].z0.getVar()
