...
- Ensure NuGet.org is accessible so the Aqualis package can be restored on first use. The examples below use `#r "nuget: Aqualis, 188.0.1"`.
...
- Line 9: Load Aqualis 188.0.1 from NuGet.
