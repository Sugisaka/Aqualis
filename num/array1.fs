...
namespace Aqualis
    ...
    type base1 (typ:Etype,x:Expr1, c:Aqualis) =
        ...
        default __.clear() =
            UnsupportedOperation.raise "This one-dimensional array type does not support clearing."

        ///<summary>配列サイズの初期化</summary>
        abstract member sizeinit: unit -> unit
        default __.sizeinit() =
            UnsupportedOperation.raise "This one-dimensional array type does not support size initialization."
