namespace Aqualis
    ...
    type complex2 (typ:Etype,x:Expr2,?context:GenerationContext) as this =
        inherit NumericArray2<complex0,complex1,complex2>(typ,x,?context=context)
        ...
        override _.Create(elementType,value)=complex2(elementType,value)
        override _.AssignAt(i,j,value)=this[i,j] <== complex0 value

        static member fiarray(a:int0,b:int0,f:int0*int0->int0)=complex2(It 4,Arx2(a,b,fun ij->(f ij).Expr))
        static member fdarray(a:int0,b:int0,f:int0*int0->double0)=complex2(Dt,Arx2(a,b,fun ij->(f ij).Expr))
        static member fzarray(a:int0,b:int0,f:int0*int0->complex0)=complex2(Zt,Arx2(a,b,fun ij->(f ij).Expr))
        static member fiarray(a:int,b:int0,f)=complex2.fiarray(I a,b,f)
        static member fdarray(a:int,b:int0,f)=complex2.fdarray(I a,b,f)
        static member fzarray(a:int,b:int0,f)=complex2.fzarray(I a,b,f)
        static member fiarray(a:int0,b:int,f)=complex2.fiarray(a,I b,f)
        static member fdarray(a:int0,b:int,f)=complex2.fdarray(a,I b,f)
        static member fzarray(a:int0,b:int,f)=complex2.fzarray(a,I b,f)
        static member fiarray(a:int,b:int,f)=complex2.fiarray(I a,I b,f)
        static member fdarray(a:int,b:int,f)=complex2.fdarray(I a,I b,f)
        static member fzarray(a:int,b:int,f)=complex2.fzarray(I a,I b,f)
