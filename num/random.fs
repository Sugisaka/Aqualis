...
namespace Aqualis
    ...
    module asm_random =
        type asm with
            ...
            static member random (code:(((int1->unit)->unit)*(double0->unit)->unit)) =
                ...
                |HTMLSequenceDiagram ->
                    ch.i1 _1 <| fun seed ->
                        ...
                        code(setseed,getrand)
                |Python ->
                    writein "random_seed = numpy.random.default_rng()"
                    ch.i1 _1 <| fun seed ->
                        let setseed code =
                            code seed
            ...
            static member random_normaldistribution code =
                asm.random <| fun (setseed,getrand) ->
                    let getrand_normal (s:double0,m:double0,x:double0) =
                        ch.dd <| fun (a,b) ->
                        getrand a
                        getrand b
