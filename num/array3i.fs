namespace Aqualis
    ...
    type int3(typ:Etype,x:Expr3,?context:GenerationContext) as this=
        ...
        static member fiarray(a:int0,b:int0,c:int0,f:int0*int0*int0->int0)=int3(It 4,Arx3(a,b,c,fun ijk->(f ijk).Expr))
        static member fdarray(a:int0,b:int0,c:int0,f:int0*int0*int0->int0)=int3(Dt,Arx3(a,b,c,fun ijk->(f ijk).Expr))
        static member fzarray(a:int0,b:int0,c:int0,f:int0*int0*int0->int0)=int3(Zt,Arx3(a,b,c,fun ijk->(f ijk).Expr))
        static member fiarray(a:int,b:int0,c:int0,f)=int3.fiarray(I a,b,c,f)
        static member fdarray(a:int,b:int0,c:int0,f)=int3.fdarray(I a,b,c,f)
        static member fzarray(a:int,b:int0,c:int0,f)=int3.fzarray(I a,b,c,f)
        static member fiarray(a:int0,b:int,c:int0,f)=int3.fiarray(a,I b,c,f)
        static member fdarray(a:int0,b:int,c:int0,f)=int3.fdarray(a,I b,c,f)
        static member fzarray(a:int0,b:int,c:int0,f)=int3.fzarray(a,I b,c,f)
        static member fiarray(a:int0,b:int0,c:int,f)=int3.fiarray(a,b,I c,f)
        static member fdarray(a:int0,b:int0,c:int,f)=int3.fdarray(a,b,I c,f)
        static member fzarray(a:int0,b:int0,c:int,f)=int3.fzarray(a,b,I c,f)
        static member fiarray(a:int,b:int,c:int0,f)=int3.fiarray(I a,I b,c,f)
        static member fdarray(a:int,b:int,c:int0,f)=int3.fdarray(I a,I b,c,f)
        static member fzarray(a:int,b:int,c:int0,f)=int3.fzarray(I a,I b,c,f)
        static member fiarray(a:int,b:int0,c:int,f)=int3.fiarray(I a,b,I c,f)
        static member fdarray(a:int,b:int0,c:int,f)=int3.fdarray(I a,b,I c,f)
        static member fzarray(a:int,b:int0,c:int,f)=int3.fzarray(I a,b,I c,f)
        static member fiarray(a:int0,b:int,c:int,f)=int3.fiarray(a,I b,I c,f)
        static member fdarray(a:int0,b:int,c:int,f)=int3.fdarray(a,I b,I c,f)
        static member fzarray(a:int0,b:int,c:int,f)=int3.fzarray(a,I b,I c,f)
        static member fiarray(a:int,b:int,c:int,f)=int3.fiarray(I a,I b,I c,f)
        static member fdarray(a:int,b:int,c:int,f)=int3.fdarray(I a,I b,I c,f)
        static member fzarray(a:int,b:int,c:int,f)=int3.fzarray(I a,I b,I c,f)
