namespace Aqualis
    ...
    type int3(typ:Etype,x:Expr3,context:Aqualis) as this=
        ...
        interface IReal3
        new(typ,x) = int3(typ,x,Aqualis.BlankWriter Numeric)
        ...
        override _.WrapMatrix value=int2(typ,value,this.Context)
        override _.CreateWithContext(elementType,value,resultContext)=int3(elementType,value,resultContext)
