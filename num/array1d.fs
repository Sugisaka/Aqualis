...
namespace Aqualis
    ...
    type double1 (typ:Etype,x:Expr1, ?context:GenerationContext) =
        inherit base1(typ,x)
        let context =
            match context with
        ...
        member this.Item with get(i:int0) = double0(this.Idx1 i)
        member this.Item with get(i:int) = double0(this.Idx1(I i))
        member this.Item with get((a:int0,b:int0)) = double1(typ,this.Idx1(a,b))
        member this.Item with get((a:int0,b:int )) = double1(typ,this.Idx1(a,b) )
        member this.Item with get((a:int ,b:int0)) = double1(typ,this.Idx1(a,b))
        member this.Item with get((a:int ,b:int )) = double1(typ,this.Idx1(a,b) )
        ...
        static member sizeMismatchError(x:double1,y:double1) =
        ...
        static member (+) (x:double1,y:double1) =
            double1.sizeMismatchError(x,y)
            double1(x.etype%%y.etype, Arx1(x.size1, fun i -> (x[i]+y[i]).Expr))
        static member (+) (x:int0,y:double1) = double1(x.etype%%y.etype,Arx1(y.size1, fun (i:int0) -> (x+y[i]).Expr))
        static member (+) (x:double0,y:double1) = double1(x.etype%%y.etype,Arx1(y.size1, fun (i:int0) -> (x+y[i]).Expr))
        static member (+) (x:complex0,y:double1) = double1(x.etype%%y.etype,Arx1(y.size1, fun (i:int0) -> (x+y[i]).Expr))
        static member (+) (x:int,y:double1) = double1((It 4)%%y.etype,Arx1(y.size1, fun (i:int0) -> (x+y[i]).Expr))
        static member (+) (x:double,y:double1) = double1(Dt%%y.etype,Arx1(y.size1, fun (i:int0) -> (x+y[i]).Expr))
        static member (+) (x:double1,y:int0) = double1(x.etype%%y.etype,Arx1(x.size1, fun i -> (x[i]+y).Expr))
        static member (+) (x:double1,y:double0) = double1(x.etype%%y.etype,Arx1(x.size1, fun i -> (x[i]+y).Expr))
        static member (+) (x:double1,y:complex0) = double1(x.etype%%y.etype,Arx1(x.size1, fun i -> (x[i]+y).Expr))
        static member (+) (x:double1,y:int) = double1(x.etype%%(It 4),Arx1(x.size1, fun i -> (x[i]+y).Expr))
        static member (+) (x:double1,y:double) = double1(x.etype%%Dt,Arx1(x.size1, fun i -> (x[i]+y).Expr))
        ...
        static member (<==) (v1:double1,v2:double1) =
            let context =
            ...
            |Arx1(_,_),Arx1(_,_) ->
                match context.CurrentProgram.language with
                |Fortran|LaTeX|C99|HTML|HTMLSequenceDiagram|Python|JavaScript|PHP|Numeric -> iter.num v1.size1 <| fun i -> v1[i] <== v2[i]
        static member (<==) (v1:double1,v2:int1) = 
            v1 <== double1(v2.Etype,v2.Expr)

        static member (<==) (v1:double1,v2:double0) =
            let context =
                v1.Context
        ...
        static member (<==) (v1:double1,v2:int0) = v1 <== double0 v2.Expr
        static member (<==) (x:double1,y:double) = x <== D y
        static member (<==) (x:double1,y:int) = x <== I y
    ...
    module asm_double1 =
        type asm with
            ...
            static member pow(x:double1,y:int) = double1(x.etype%%It 4,Arx1(x.size1,fun i -> asm.pow(x[i],y).Expr))
            static member pow(x:double1,y:double) = double1(x.etype%%Dt,Arx1(x.size1,fun i -> asm.pow(x[i],y).Expr))
