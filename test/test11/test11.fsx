...
type Distribution(u:(int0*double0)->double0,n1:int0,n2:int0,x0:double0,dx:double0,c:Aqualis) =
    ...
    static member ( + ) (a:Distribution,b:Distribution) = Distribution((fun (n,x) -> a.f (n,x) + b.f (n,x)),a.N1,a.N2,a.X0,a.Dx,a.ctx)
    static member ( - ) (a:Distribution,b:Distribution) = Distribution((fun (n,x) -> a.f (n,x) - b.f (n,x)),a.N1,a.N2,a.X0,a.Dx,a.ctx)
    static member ( * ) (a:Distribution,b:Distribution) = Distribution((fun (n,x) -> a.f (n,x) * b.f (n,x)),a.N1,a.N2,a.X0,a.Dx,a.ctx)
    static member ( / ) (a:Distribution,b:Distribution) = Distribution((fun (n,x) -> a.f (n,x) / b.f (n,x)),a.N1,a.N2,a.X0,a.Dx,a.ctx)
    static member ( + ) (a:Distribution,b:double0->double0) = Distribution((fun (n,x) -> a.f (n,x) + b x),a.N1,a.N2,a.X0,a.Dx,a.ctx)
    static member ( - ) (a:Distribution,b:double0->double0) = Distribution((fun (n,x) -> a.f (n,x) - b x),a.N1,a.N2,a.X0,a.Dx,a.ctx)
    static member ( * ) (a:Distribution,b:double0->double0) = Distribution((fun (n,x) -> a.f (n,x) * b x),a.N1,a.N2,a.X0,a.Dx,a.ctx)
    static member ( / ) (a:Distribution,b:double0->double0) = Distribution((fun (n,x) -> a.f (n,x) / b x),a.N1,a.N2,a.X0,a.Dx,a.ctx)
    static member ( + ) (a:double0->double0,b:Distribution) = Distribution((fun (n,x) -> a x + b.f (n,x) ),b.N1,b.N2,b.X0,b.Dx,b.ctx)
    static member ( - ) (a:double0->double0,b:Distribution) = Distribution((fun (n,x) -> a x - b.f (n,x) ),b.N1,b.N2,b.X0,b.Dx,b.ctx)
    static member ( * ) (a:double0->double0,b:Distribution) = Distribution((fun (n,x) -> a x * b.f (n,x) ),b.N1,b.N2,b.X0,b.Dx,b.ctx)
    static member ( / ) (a:double0->double0,b:Distribution) = Distribution((fun (n,x) -> a x / b.f (n,x) ),b.N1,b.N2,b.X0,b.Dx,b.ctx)
    static member ( <== ) (a:Distribution,b:Distribution) = 
        a.ctx.iter.range (a.N1,a.N2) <| fun i ->
            a.ctx.ch.d <| fun x ->
                x <== a.x i
                a.f (i,x) <== b.f (i,x)
    static member ( <== ) (a:Distribution,b:double0->double0) = 
        a.ctx.iter.range (a.N1,a.N2) <| fun i ->
            a.ctx.ch.d <| fun x ->
                x <== a.x i
                a.f (i,x) <== b x
...
type DistributionContext(c:Aqualis) =
    member _.d(m1:int0,m2:int0,x0:double0,dx:double0) = fun code ->
        c.ch.d1 (m2-m1+1) <| fun v ->
            let p = Distribution((fun (n:int0,_) -> v[n-m1]),m1,m2,x0,dx,c)
            code p
    member _.sum (g:Distribution) =
