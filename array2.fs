...
namespace Aqualis
    ...
    type base2 (typ:Etype,x:Expr2) =
        ...
        member this.Idx2(i:num0,(a2:num0,b2:int)) = Arx1(b2-a2+_1,  fun j -> this.Idx2(i,j+a2-1))
        member this.Idx2(i:num0,(a2:int,b2:num0)) = Arx1(b2-a2+_1,  fun j -> this.Idx2(i,j+a2-1))
        member this.Idx2(i:num0,(a2:int,b2:int)) = Arx1(b2-a2+_1,  fun j -> this.Idx2(i,j+a2-1))
        member this.Idx2(i:num0,_:unit) = Arx1(this.size2,  fun j -> this.Idx2(i,j))
        member this.Idx2(i:int,(a2:num0,b2:num0)) = Arx1(b2-a2+_1,  fun j -> this.Idx2(i.I,j+a2-1))
        member this.Idx2(i:int,(a2:num0,b2:int)) = Arx1(b2-a2+_1,  fun j -> this.Idx2(i.I,j+a2-1))
        member this.Idx2(i:int,(a2:int,b2:num0)) = Arx1(b2-a2+_1,  fun j -> this.Idx2(i.I,j+a2-1))
        member this.Idx2(i:int,(a2:int,b2:int)) = Arx1(b2-a2+_1,  fun j -> this.Idx2(i.I,j+a2-1))
        ...
        member this.Idx2((a1:num0,b1:num0),j:int) = Arx1(b1-a1+_1,  fun i -> this.Idx2(i+a1-1,j.I))
        member this.Idx2((a1:num0,b1:num0),(a2:num0,b2:num0)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:num0,b1:num0),(a2:num0,b2:int)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:num0,b1:num0),(a2:int,b2:num0)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:num0,b1:num0),(a2:int,b2:int)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:num0,b1:num0),_:unit) = Arx2(b1-a1+_1, this.size2,  fun (i,j) -> this.Idx2(i+a1-1,j))
        member this.Idx2((a1:num0,b1:int),j:num0) = Arx1(b1-a1+_1,  fun i -> this.Idx2(i+a1-1,j))
        member this.Idx2((a1:num0,b1:int),j:int) = Arx1(b1-a1+_1,  fun i -> this.Idx2(i+a1-1,j.I))
        member this.Idx2((a1:num0,b1:int),(a2:num0,b2:num0)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:num0,b1:int),(a2:num0,b2:int)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:num0,b1:int),(a2:int,b2:num0)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:num0,b1:int),(a2:int,b2:int)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:num0,b1:int),_:unit) = Arx2(b1-a1+_1, this.size2,  fun (i,j) -> this.Idx2(i+a1-1,j))
        member this.Idx2((a1:int,b1:num0),j:num0) = Arx1(b1-a1+_1,  fun i -> this.Idx2(i+a1-1,j))
        member this.Idx2((a1:int,b1:num0),j:int) = Arx1(b1-a1+_1,  fun i -> this.Idx2(i+a1-1,j.I))
        member this.Idx2((a1:int,b1:num0),(a2:num0,b2:num0)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:int,b1:num0),(a2:num0,b2:int)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:int,b1:num0),(a2:int,b2:num0)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:int,b1:num0),(a2:int,b2:int)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:int,b1:num0),_:unit) = Arx2(b1-a1+_1, this.size2,  fun (i,j) -> this.Idx2(i+a1-1,j))
        member this.Idx2((a1:int,b1:int),j:num0) = Arx1(b1-a1+_1,  fun i -> this.Idx2(i+a1-1,j))
        member this.Idx2((a1:int,b1:int),j:int) = Arx1(b1-a1+_1,  fun i -> this.Idx2(i+a1-1,j.I))
        member this.Idx2((a1:int,b1:int),(a2:num0,b2:num0)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:int,b1:int),(a2:num0,b2:int)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:int,b1:int),(a2:int,b2:num0)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:int,b1:int),(a2:int,b2:int)) = Arx2(b1-a1+_1, b2-a2+_1,  fun (i,j) -> this.Idx2(i+a1-1,j+a2-1))
        member this.Idx2((a1:int,b1:int),_:unit) = Arx2(b1-a1+_1, this.size2,  fun (i,j) -> this.Idx2(i+a1-1,j))
        ...
        member this.Idx2(_:unit,(a2:num0,b2:int)) = Arx2(this.size1, b2-a2+_1,  fun (i,j) -> this.Idx2(i,j+a2-1))
        member this.Idx2(_:unit,(a2:int,b2:num0)) = Arx2(this.size1, b2-a2+_1,  fun (i,j) -> this.Idx2(i,j+a2-1))
        member this.Idx2(_:unit,(a2:int,b2:int)) = Arx2(this.size1, b2-a2+_1,  fun (i,j) -> this.Idx2(i,j+a2-1))
    ...
    type num2 (typ:Etype,x:Expr2) =
        ...
        static member (<==) (v1:num2,v2:num2) =
            ...
            |Var2(_,x),Arx2(_,_,f) ->
                match p.lang with
                |F|T|C|H|P -> iter.num v1.size1 <| fun i -> iter.num v1.size2 <| fun j -> v1[i,j] <== v2[i,j]
            |Arx2(_,_,_),Var2(_,_) ->
                match p.lang with
                |F|T|C|H|P -> iter.num v1.size1 <| fun i -> iter.num v1.size2 <| fun j -> v1[i,j] <== v2[i,j]
